package com.example.karza.client;

import com.example.Exception.BadRequestException;
import com.example.Exception.ServiceNotAvailableException;
import com.example.Exception.UnauthorisedException;
...
public class KarzaClient {
    ...
    public KarzaResponse verifyPan(KarzaRequest karzaRequest) {
        ...
        try {
            ...
            LOG.error("HTTP Error: {}, Message: {}", statusCode, e.getMessage());
